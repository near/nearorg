...
export const HomePagePort = () => {
  // const { fetchEventsList } = props; TODO

  const ipfsImages = {
    apps: {
      bosAllStars:
        "bafkreicgnsizdxoc436tbln3ucqo45hdauumd7if4gltrqh3tbxgosi3q4",
    ...
    illustrations: {
      ...
      placeholder:
        "bafkreid7abzwnzk3qrniq7mnnl4blhka7k5nk62m3u7afqnqdxowmrkdu4",
    },
    logos: {
            ...
            <PatternContent>
              <Flex gap="32px" direction="column" alignItems="center">
                ...
                <Text size="text-l" mobileSize="text-base">
                  NEAR is the chain abstraction stack, empowering builders to
                  create apps that scale to billions of users and across all
                  blockchains.
                </Text>
        ...
        <Container>
          <Flex direction="column" gap="24px">
            ...
            >
              ...
              transparent and resilient – shaped and controlled by their
              creators and users.
            </Text>
          </Flex>
          ...
          <Grid columns="1fr 1fr" gap="var(--section-gap)">
            <Widget
              src="${REPL_MOB}/widget/Image"
              props={{
                image: returnIpfsImage(
                  ipfsImages.illustrations.betterWayToBuild
                ),
            ...
            <Flex direction="column" gap="var(--section-gap)">
              ...
              <Flex direction="column" gap="24px">
                ...
                <Text>
                  No more jumping through hoops to reach your audience.{" "}
                  {`Near's`} Blockchain Operating System (B.O.S) enables you to
                  host and serve your applications entirely on the blockchain,
            ...
            <Flex direction="column" gap="24px">
              ...
              >
                <Text style={{ maxWidth: "598px", marginRight: "auto" }}>
                  Develop unique and powerful ways to earn, transact, and
                  exercise digital ownership through online experiences
            ...
            props={{
              content: (
                <>
                  ...
                  <Text color="white">
                    Spend less time learning and more time building with the
            ...
            props={{
              content: (
                <>
                  ...
                  <Text color="white">
                    Open-source components built with public blockchain data
                    allow you to create rich user experiences without wasting
        ...
        <Container>
          <Flex direction="column" gap="24px">
            ...
            <Text
              ...
              style={{ maxWidth: "808px" }}
            >
              Current Web3 experiences are siloed & inaccessible. They don’t
              have to be.
            </Text>
          </Flex>
              ...
              content: (
                <>
                  ...
                  <Text>
                    ...
                    compromising your reach, all while getting the best of
            ...
            props={{
              content: (
                <>
                  ...
                  <Text>
                    With FastAuth, onboarding to your decentralized application
                    is even faster and easier than traditional web
                    authentication.
                  </Text>
                  <div>
                    <Button
        ...
        <Container>
          <Flex direction="column" gap="24px">
            ...
            <Text
              ...
              style={{ maxWidth: "808px" }}
            >
              Join a vibrant community of innovators and builders creating a
              more open web.
            </Text>
          </Flex>
            ...
            <Flex direction="column" gap="24px">
              ...
              >
                <Text
                  ...
                  color="white"
                >
                  Everything you need to know about NEAR from ongoing
                  developments to the latest updates.
                </Text>
              </Flex>
            </Flex>
            ...
            <Flex direction="column" gap="24px">
              ...
              >
                <Text
                  ...
                  color="white"
                >
                  Connect with people to help you on your journey across the
                  open web.
                </Text>
