          ...
          <NavList>
            <NavItem key={'home'}>
              <NavTrigger onMouseEnter={recordMouseEnter}>
                <NavLink asChild>
                  <Link href={'/beta'} style={{ fontSize: '2rem' }}>
                    NEAR AI
                  </Link>
                </NavLink>
              </NavTrigger>
            ...
            <NavItem key={'aiOfficeHours'}>
              <NavTrigger onMouseEnter={recordMouseEnter}>
                <NavLink asChild>
                  <Link
                    href={'https://www.youtube.com/watch?v=ye_2k7dxtCE&list=PL9tzQn_TEuFWMuPiQOXhaE5lpOTnxLPZY'}
                    target="_blank"
                    style={{ padding: 0 }}
                  >
                    AI Office Hours
            ...
            <NavItem key={'about'}>
              <NavTrigger onMouseEnter={recordMouseEnter}>
                <NavLink asChild>
                  <Link href={'/about'} style={{ padding: 0 }}>
                    About
                  </Link>
                </NavLink>
              </NavTrigger>
