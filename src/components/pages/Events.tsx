...
const Pattern = styled.div`
  ...
  display: flex;
  align-items: center;
  background-image: url('${returnImageSrc(backgroundAsset1)}'), url('${returnImageSrc(backgroundAsset2)}'), url('${returnImageSrc(backgroundAsset3)}'),
    url('${returnImageSrc(backgroundAsset4)}'),
