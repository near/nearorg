    ...
    >
      <div className="bg-black/30 border border-[#00EB9A]/20 rounded-xl p-6 mb-16">
        ...
        <ul className="text-[#AFD0C5] list-disc pl-4 space-y-3">
          ...
          <li>We have launched the NEAR AI Research Hub to coordinate and incentivize researchers to work together to build these models. The first competition is now live at <a href="http://app.near.ai" className="text-[#00EB9A] no-underline hover:underline">app.near.ai</a></li>
        </ul>
      </div>
      ...
      <p className="text-lg leading-relaxed mb-12 text-[#AFD0C5]">
        The first competition to train the 0.5B parameter model is open right now. Learn more, <a href="https://forms.gle/N9y5TGBcyoxVeFiCA" className="text-[#00EB9A] no-underline hover:underline">apply to participate</a>, and subscribe for updates about future competitions at <a href="http://app.near.ai" className="text-[#00EB9A] no-underline hover:underline">app.near.ai</a>.
      </p>
      ...
      <p className="text-lg leading-relaxed mb-12 text-[#AFD0C5]">
        With TEE-enabled inference and training, an ecosystem contributing the necessary decentralized infrastructure components, and a training competition to build the best frontier model in an open and distributed way, we believe NEAR AI Research Hub is poised to achieve User-Owned AI that is better than the for-profit, centralized AI dominating the market today. Join us at <a href="http://app.near.ai" className="text-[#00EB9A] no-underline hover:underline">app.near.ai</a> or <a href="https://forms.gle/N9y5TGBcyoxVeFiCA" className="text-[#00EB9A] no-underline hover:underline">apply to participate</a> in the competition.
      </p>
    </BlogPost>
  );
};
